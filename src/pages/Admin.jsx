            ...
            <div className="grid grid-cols-3 gap-4 mb-6">
              <div className="p-4 rounded-lg bg-blue-50">
                ...
                <p className="text-2xl font-bold text-gray-800">
                  ₱
                  {dashboardData.salesAnalytics.income.toLocaleString("en-US", {
              ...
              <div className="p-4 rounded-lg bg-orange-50">
                ...
                <p className="text-2xl font-bold text-gray-800">
                  ₱
                  {dashboardData.salesAnalytics.expenses.toLocaleString(
                    "en-US",
              ...
              <div className="p-4 rounded-lg bg-green-50">
                ...
                <p className="text-2xl font-bold text-gray-800">
                  ₱
                  {dashboardData.salesAnalytics.balance.toLocaleString(
                    "en-US",
                    { minimumFractionDigits: 2, maximumFractionDigits: 2 }
                  )}
                </p>
...
function StatCard({ title, value, period, change, icon, color, iconColor }) {
  ...
  return (
    <div
      className={`${color} p-6 rounded-lg shadow-sm border hover:shadow-md transition-all duration-300 ease-in-out`}
    >
      <div className="flex justify-between items-start mb-4">
        ...
        <div
          className={`w-10 h-10 rounded-full ${iconColor} flex items-center justify-center text-xl`}
        >
          {icon}
        </div>
      </div>
